class DropBoxController {
    ...
    connectFirebase() {
        var firebaseConfig = {
            apiKey: "AIzaSyAKCi1Lktf3xzSAMaofzsC34d-ASNRk_5Y",
            authDomain: "dropboxclone-48967.firebaseapp.com",
            databaseURL: "https://dropboxclone-48967.firebaseio.com",
            projectId: "dropboxclone-48967",
            storageBucket: "dropboxclone-48967.appspot.com",
            messagingSenderId: "388212511481",
            appId: "1:388212511481:web:5af4113fb4d6ab5a020828",
            measurementId: "G-T09YJV1J1S"
            };
          // Initialize Firebase
    ...
    // hides the load bar after finishing
    modalShow(show = true) {
    ...
    // shows how much time is left to finish
    ...
    // list firebase database values. Shows on the main screen
    readFiles() {
